...
{
    public partial class EditControlRows : UserControl
    {
        //private readonly EditControlRowsViewModel _viewModel;

        #region Constructors and Load

        public EditControlRows(EditControlRowsViewModel viewModel)
        {
