...
{
    public class PageScratchViewModel : PageShapeSheetSectionBase
    {
        public PageScratchViewModel() : base()
        {
        ...
        public override void OnUpdateSettingsExecute()
        {
            ...
            int undoScope = Globals.ThisAddIn.Application.BeginUndoScope("UpdatePageScratch");
