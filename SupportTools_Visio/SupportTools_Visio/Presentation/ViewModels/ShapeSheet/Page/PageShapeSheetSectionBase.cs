...
{
    public class PageShapeSheetSectionBase : ViewModelBase
    {
        ...
        public PageShapeSheetSectionBase()
        {
        ...
        string _LoadButtonContent = "Load from Current Page";
        ...
        string _UpdateButtonContent = "Update Page";
        ...
        public virtual Boolean OnLoadCurrentSettingsCanExecute()
        {
            ...
            if (page != null)
            {
                ...
                LoadButtonContent = "Refresh from Page";

                return true;
            }
            else
            {
                LoadButtonContent = "No active page";
