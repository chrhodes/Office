...
{
    public class DocumentHyperLinksViewModel : DocumentShapeSheetSectionBase
    {
        public DocumentHyperLinksViewModel() : base()
        {
            Int64 startTicks = Log.CONSTRUCTOR("Enter", Common.LOG_APPNAME);

            UpdateButtonContent = "Reload Document Hyperlinks";
        ...
        public override void OnUpdateSettingsExecute()
        {
            ...
            int undoScope = Globals.ThisAddIn.Application.BeginUndoScope("UpdateDocumentHyperlinks");
