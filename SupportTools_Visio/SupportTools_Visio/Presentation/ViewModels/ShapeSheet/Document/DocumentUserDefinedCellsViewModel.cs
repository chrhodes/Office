...
{
    public class DocumentUserDefinedCellsViewModel : DocumentShapeSheetSectionBase
    {



        public DocumentUserDefinedCellsViewModel() : base()
        {
            Int64 startTicks = Log.CONSTRUCTOR("Enter", Common.LOG_APPNAME);

            UpdateButtonContent = "Reload Document UserDefinedCells";
        ...
        public override void OnUpdateSettingsExecute()
        {
            ...
            int undoScope = Globals.ThisAddIn.Application.BeginUndoScope("UpdateDocumentUserDefinedCells");
