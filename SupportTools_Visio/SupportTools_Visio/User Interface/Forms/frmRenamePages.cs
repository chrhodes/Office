...
{
    public partial class frmRenamePages : Form
    {
        private System.Windows.Forms.Integration.ElementHost elementHost;
        private System.Windows.Controls.UserControl wucUserControl;
        

        public frmRenamePages()
        {
            InitializeComponent();
            LoadDefaultXamlUI();
        }

        public frmRenamePages(string wpfUserControlName)
        {
            InitializeComponent();
        ...
        void LoadDefaultXamlUI()
        {
            ...
            wucUserControl = new User_Controls.wucRenamePages();
